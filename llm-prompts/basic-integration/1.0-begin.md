...
Keep task titles broad and job-oriented. Describe the purpose or area of work like "Plan event tracking", "Identifying users", "Installing PostHog", or "Create a dashboard", not the specific files, paths, or symbols involved.

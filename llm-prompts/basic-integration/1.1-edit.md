...
Remember: Do not alter the fundamental architecture of existing files. Make your additions minimal and targeted. Focus on the most impactful integration points (main entry, key routes, error handlers) rather than exhaustively instrumenting every file.

...
Before creating dashboards or insights, check what already exists using dashboards-get-all and insights-get-all. Search by name — if a matching dashboard or insight exists, reuse it instead of creating a duplicate.

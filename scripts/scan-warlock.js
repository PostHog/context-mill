...
function createLLMProvider() {
  ...
  const apiKey = process.env.ANTHROPIC_AUTH_TOKEN || process.env.POSTHOG_API_TOKEN;
...
async function main() {
  ...
  if (llmProvider) {
    ...
    console.log(
      "LLM triage disabled (no POSTHOG_API_TOKEN set). Matches will be treated as threats.\n",
    );
  }

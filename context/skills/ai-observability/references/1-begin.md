...
For `manual-capture`, use `references/manual-capture.md` to list every inference entry point, its transport, and capture status. Keep this ledger for verification and the handoff.

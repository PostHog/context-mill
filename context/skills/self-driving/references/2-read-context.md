...
5. **Write down your working checklist** (in your own notes, not a file): candidate native sources, candidate connected tools, which products this project uses most (drives step 6's pick: `general` + the 2–3 most-used specialists), GitHub status if the profile revealed it. Steps 4–6 consume this.

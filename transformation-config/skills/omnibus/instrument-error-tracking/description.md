...
Supported platforms: React, Next.js, Web (JavaScript), Node.js, Python, PHP, Ruby, Ruby on Rails, Go, Elixir, Angular, Svelte, Nuxt, React Native, Flutter, Android, and Hono.
...
STEP 1: Analyze the codebase and detect the platform.
  - Look for dependency files (package.json, requirements.txt, go.mod, Gemfile, composer.json, mix.exs, etc.) to determine the language and framework.
